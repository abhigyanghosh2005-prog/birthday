            ...
            <div className="flex flex-col items-center gap-6">
                ...
                <div>
                    <h1 className="text-pretty text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-pink-400 drop-shadow leading-tight"
                        ...
                        Congratulations on no longer being a minor!
                    </h1>
                    ...
                    <p className="mt-4 text-xl text-pink-200">Welcome to Adulthood! Cheers to more freedom, more responsibility, and making your own rules.</p>
                </div>
